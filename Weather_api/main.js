const getData = async (Location) => {
    let response = await axios.get(`https://api.openweathermap.org/data/2.5/weather?q=${Location}&appid=1fe615ecac65e9971fefb0589ba0f5c7&units=imperial`)
...
form.addEventListener('submit', (event) => {
    ...
    let queryLocation = document.querySelector('#Location').value
    loadData(queryLocation)
})